package com.arfirman1402.dev.wikif1.newactivity.season.view;
...
import com.arfirman1402.dev.wikif1.newactivity.season.presenter.ISeasonP;
import com.arfirman1402.dev.wikif1.newactivity.season.presenter.SeasonP;
import com.arfirman1402.dev.wikif1.newactivity.season.view.holder.VHRace;
...
public class SeasonActivity extends BaseActivity<ISeasonM> implements SeasonV {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Race> races = Arrays.asList(App.getInstance().getGson().fromJson(getIntent().getExtras().getString("races"), Race[].class));

        seasonRaceDataList.clear();
        seasonRaceDataList.addAll(races);
